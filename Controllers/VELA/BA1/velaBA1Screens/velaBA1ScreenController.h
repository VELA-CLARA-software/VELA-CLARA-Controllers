...
class velaBA1ScreenController : public screenController
{
    public:
...
BOOST_PYTHON_MODULE( velaBA1ScreenControl )
{
...
/// we have to tell boost.python about pure virtual methods in abstract base classes
    ...
    boost::python::class_<velaBA1ScreenController, boost::python::bases<controller>>("velaBA1ScreenController")
                ...
                .def("set_CA_PEND_IO_TIMEOUT",              &velaBA1ScreenController::set_CA_PEND_IO_TIMEOUT    )
                .def("getComplexHorizontalScreenState",     &velaBA1ScreenController::getComplexHorizontalScreenState_Py)
                .def("getComplexVerticalScreenState",       &velaBA1ScreenController::getComplexVerticalScreenState_Py)
                .def("getSimpleScreenState",                &velaBA1ScreenController::getSimpleScreenState_Py)
//                .def("getScreenState",                      &velaBA1ScreenController::getScreenState, getScreenState_1)
//                .def("getScreenState",                      &velaBA1ScreenController::getScreenState, getScreenState_2)
                //.def("getScreenState",                      &velaBA1ScreenController::getScreenState_Py, screen_overloads() )
                .def("getComplexScreenHorizontalPosition",  &velaBA1ScreenController::getComplexScreenHorizontalPosition_Py)
                .def("getComplexScreenVerticalPosition",    &velaBA1ScreenController::getComplexScreenVerticalPosition_Py)
                .def("getScreenPosition",                   &velaBA1ScreenController::getScreenPosition_Py)
                .def("get_info",                            &velaBA1ScreenController::get_info_Py)
                .def("get_config_values",                   &velaBA1ScreenController::get_config_values_Py)
                .def("getILockStates",                      &velaBA1ScreenController::getILockStates_Py)
                .def("Screen_Out",                          &velaBA1ScreenController::Screen_Out_Py )
                .def("Screen_In",                           &velaBA1ScreenController::Screen_In_Py )
                .def("Screen_Move",                         &velaBA1ScreenController::Screen_Move_Py )
                .def("Screen_Stop",                         &velaBA1ScreenController::Screen_Stop_Py )
                .def("controller_move_to_position",         &velaBA1ScreenController::controller_move_to_position_Py )
                .def("controller_move_to",                  &velaBA1ScreenController::controller_move_to_Py )
                .def("IsIn",                                &velaBA1ScreenController::IsIn_Py, boost::python::args("name") )
                .def("IsOut",                               &velaBA1ScreenController::IsOut_Py, boost::python::args("name") )///Should this be the same as IsIn?
                .def("horizontal_disabled_check",           &velaBA1ScreenController::horizontal_disabled_check_Py )
                .def("vertical_disabled_check",             &velaBA1ScreenController::vertical_disabled_check_Py )
                .def("debugMessagesOff",                    &velaBA1ScreenController::debugMessagesOff )
                .def("debugMessagesOn",                     &velaBA1ScreenController::debugMessagesOn )
                .def("messagesOff",                         &velaBA1ScreenController::messagesOff )
                .def("messagesOn",                          &velaBA1ScreenController::messagesOn )
                .def("silence",                             &velaBA1ScreenController::silence )
                .def("verbose",                             &velaBA1ScreenController::verbose )
           ;
};//BOOST_PYTHON_MODULE
#endif //BUILD_DLL
