...
class velaBA2ScreenController : public screenController
{
    public:
    ///we have overloaded constructors to specify config-file location
        velaBA2ScreenController(const bool RealMachine = false, const bool show_messages = true , const bool show_debug_messages = true );
        velaBA2ScreenController( const std::string configFileLocation1,
                          const std::string configFileLocation2, const bool show_messages = true, const bool show_debug_messages = true );
        ~velaBA2ScreenController();
...
BOOST_PYTHON_MODULE( velaBA2ScreenControl )
{
...
/// we have to tell boost.python about pure virtual methods in abstract base classes
    ...
    boost::python::class_<velaBA2ScreenController, boost::python::bases<controller>>("velaBA2ScreenController")
                ...
                .def("getScreenStateDefinition",            &velaBA2ScreenController::getScreenStateDefinition )
                .def("detILockStatesDefinition",            &velaBA2ScreenController::getILockStatesDefinition )
                .def("get_CA_PEND_IO_TIMEOUT",              &velaBA2ScreenController::get_CA_PEND_IO_TIMEOUT    )
                .def("set_CA_PEND_IO_TIMEOUT",              &velaBA2ScreenController::set_CA_PEND_IO_TIMEOUT    )
                .def("getComplexHorizontalScreenState",     &velaBA2ScreenController::getComplexHorizontalScreenState_Py)
                .def("getComplexVerticalScreenState",       &velaBA2ScreenController::getComplexVerticalScreenState_Py)
                .def("getSimpleScreenState",                &velaBA2ScreenController::getSimpleScreenState_Py)
//                .def("getScreenState",                      &velaBA2ScreenController::getScreenState, getScreenState_1)
//                .def("getScreenState",                      &velaBA2ScreenController::getScreenState, getScreenState_2)
                //.def("getScreenState",                      &velaBA2ScreenController::getScreenState_Py, screen_overloads() )
                .def("getComplexScreenHorizontalPosition",  &velaBA2ScreenController::getComplexScreenHorizontalPosition_Py)
                .def("getComplexScreenVerticalPosition",    &velaBA2ScreenController::getComplexScreenVerticalPosition_Py)
                .def("getScreenPosition",                   &velaBA2ScreenController::getScreenPosition_Py)
                .def("get_info",                            &velaBA2ScreenController::get_info_Py)
                .def("get_config_values",                   &velaBA2ScreenController::get_config_values_Py)
                .def("getILockStates",                      &velaBA2ScreenController::getILockStates_Py)
                .def("Screen_Out",                          &velaBA2ScreenController::Screen_Out_Py )
                .def("Screen_In",                           &velaBA2ScreenController::Screen_In_Py )
                .def("Screen_Move",                         &velaBA2ScreenController::Screen_Move_Py )
                .def("Screen_Stop",                         &velaBA2ScreenController::Screen_Stop_Py )
                .def("controller_move_to_position",         &velaBA2ScreenController::controller_move_to_position_Py )
                .def("controller_move_to",                  &velaBA2ScreenController::controller_move_to_Py )
                .def("IsIn",                                &velaBA2ScreenController::IsIn_Py, boost::python::args("name") )
                .def("IsOut",                               &velaBA2ScreenController::IsOut_Py, boost::python::args("name") )///Should this be the same as IsIn?
                .def("horizontal_disabled_check",           &velaBA2ScreenController::horizontal_disabled_check_Py )
                .def("vertical_disabled_check",             &velaBA2ScreenController::vertical_disabled_check_Py )
                .def("debugMessagesOff",                    &velaBA2ScreenController::debugMessagesOff )
                .def("debugMessagesOn",                     &velaBA2ScreenController::debugMessagesOn )
                .def("messagesOff",                         &velaBA2ScreenController::messagesOff )
                .def("messagesOn",                          &velaBA2ScreenController::messagesOn )
                .def("silence",                             &velaBA2ScreenController::silence )
                .def("verbose",                             &velaBA2ScreenController::verbose )
           ;
};//BOOST_PYTHON_MODULE
#endif //BUILD_DLL
