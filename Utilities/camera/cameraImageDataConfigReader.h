...
//  FileName:    cameraImageDataConfigReader.h
//  Description:
//
//
//*/
#ifndef __CAMERA_IMAGE_DATA_CONFIG_READER_
#define __CAMERA_IMAGE_DATA_CONFIG_READER_
// stl
#include <string>
#include <vector>
#include <map>
...
class cameraImageDataConfigReader : public configReader
{
    public:
        cameraImageDataConfigReader();
        cameraImageDataConfigReader::cameraImageDataConfigReader(const std::string& config,
...
#endif //__CAMERA_IMAGE_DATA_CONFIG_READER_
