...
virtualCathodeConfigReader::virtualCathodeConfigReader( const std::string & configFileLocation1,
...
//}
////______________________________________________________________________________
//void virtualCathodeConfigReader::addToPVStruct(std::vector< pilaserStructs::pvStruct > & pvs, const pilaserStructs::PILASER_PV_TYPE pvtype, const std::string& pvSuffix)
//{
...
//}
////______________________________________________________________________________
//void virtualCathodeConfigReader::addTopilaserObjectsV1( const std::vector<std::string> &keyVal   )
//{
...
//}
////______________________________________________________________________________
//bool virtualCathodeConfigReader::getpilaserObject( pilaserStructs::pilaserObject & obj )
//{
//    obj = pilaserObject;
