...
class laserTransportMirrorConfigReader:public configReader
{
    public:
        laserTransportMirrorConfigReader(const std::string& vcMirrorConfig,
                                         const bool& show_messages,
                                         const bool& show_debug_messages,
                                         const bool usingVM);

        ~laserTransportMirrorConfigReader();
        bool readConfig();
        bool getMirrorObject(pilaserStructs::pilMirrorObject& obj);
        bool getMirrorObject(pilaserStructs::pilaserObject& obj);
    private:
        ...
        pilaserStructs::pilMirrorObject mirror;
