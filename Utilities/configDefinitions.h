...
namespace UTL
{
    ...
    const std::string CLARANET_CONFIG_PATH = "\\\\claraserv3.dl.ac.uk\\claranet\\packages\\vcc\\Python38_x64\\VIRTUAL_CONFIG\\";//"C:\\Users\\ujo48515\\Documents\\VELA-CLARA-Controllers\\Config\\"; //\\\\claraserv3.dl.ac.uk\\claranet\\packages\\vcc\\Python38_x64\\Config\\";
...
/// PI Laser
    ...
    const std::string PV_SUFFIX_PIL_HALF_WAVE_PLATE_ENABLE = "PV_SUFFIX_PIL_HALF_WAVE_PLATE_ENABLE";
...
//    const std::string PV_SUFFIX_TIMING     = "PV_SUFFIX_TIMING";
    ...
    const std::string PV_SUFFIX_LIB_MAX_AMP_SP = "PV_SUFFIX_LIB_MAX_AMP_SP";
