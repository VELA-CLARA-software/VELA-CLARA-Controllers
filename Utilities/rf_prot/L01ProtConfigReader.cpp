...
//  FileName:    L01ProtConfigReader.cpp
//  Description:
//
//
//*/
...
{}
//______________________________________________________________________________
L01ProtConfigReader::~L01ProtConfigReader(){}
//______________________________________________________________________________
bool L01ProtConfigReader::getrfProtObjects(std::map<std::string, rfProtStructs::rfProtObject>& mapToFill )
{
    ...
    {
        message("!!!L01ProtConfigReader ERROR!!!! Found ", mapToFill.size(), " objects and expecetd ",numObjs );
    }
    return r;
}
//______________________________________________________________________________
bool L01ProtConfigReader::readConfig()
{
...
//______________________________________________________________________________
void L01ProtConfigReader::addToPVMonitorMapV1(const std::vector<std::string> &keyVal )
{
    addToPVStruct(pvMonStructs, keyVal);
}
//______________________________________________________________________________
void L01ProtConfigReader::addToPVCommandMapV1(const std::vector<std::string> &keyVal )
{
    addToPVStruct(pvComStructs, keyVal);
}
//______________________________________________________________________________
void L01ProtConfigReader::addToProtObjectsV1(const std::vector<std::string> &keyVal )
{
...
//______________________________________________________________________________
void L01ProtConfigReader::addToPVStruct(std::vector< rfProtStructs::pvStruct >  & pvStruct_v, const std::vector<std::string> &keyVal )
{
...
//______________________________________________________________________________
void L01ProtConfigReader::addCOUNT_MASK_OR_CHTYPE(std::vector< rfProtStructs::pvStruct > & pvStruct_v, const std::vector<std::string> &keyVal  )
{
...
////______________________________________________________________________________
//bool L01ProtConfigReader::readConfig(L01ProtConfigReader & obj, const std::string fn, aKeyValMemFn f1, aKeyValMemFn f2, aKeyValMemFn f3 )
//{
