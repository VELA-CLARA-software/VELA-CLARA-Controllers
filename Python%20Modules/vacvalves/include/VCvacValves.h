...
//        velaINJBeamPositionMonitorController( const bool show_messages = true, const bool show_debug_messages = true, const std::string configFileLocation );
    ...
    private:
        ...
        bool virtual_VELA_INJ_Vac_Valve_Controller_Obj_Exists;
        bool offline_VELA_INJ_Vac_Valve_Controller_Obj_Exists;
        bool physical_VELA_INJ_Vac_Valve_Controller_Obj_Exists;
