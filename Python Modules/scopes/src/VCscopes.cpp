...
{
    std::cout << "creating object" << std::endl;
    const std::string scopeconf1 = UTL::CONFIG_PATH_VM + UTL::CLARA_SCOPE_CONFIG;
    const std::string scopeconf2 = UTL::CONFIG_PATH_VM + UTL::CLARA_SCOPE_TRACE_CONFIG;
    ...
    {
        virtual_CLARA_INJ_Scope_Controller_Obj = new scopeController( scopeconf1, scopeconf2, true, true, true );
    }
...
scopeController & VCscopes::offline_CLARA_INJ_Scope_Controller()
{
    ...
    {
        offline_CLARA_INJ_Scope_Controller_Obj = new scopeController( scopeconf1, scopeconf2, true, true, false );
    }
...
scopeController & VCscopes::physical_CLARA_INJ_Scope_Controller()
{
    ...
    {
        physical_CLARA_INJ_Scope_Controller_Obj = new scopeController( scopeconf1, scopeconf2, true, true, true );
    }
