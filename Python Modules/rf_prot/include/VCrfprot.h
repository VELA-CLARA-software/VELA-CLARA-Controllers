...
bool(gunProtController::*reset_1  )(const std::string&)              = &gunProtController::reset;
bool(gunProtController::*reset_2  )(const std::vector<std::string>&) = &gunProtController::reset;
bool(gunProtController::*enable_1 )(const std::string&)              = &gunProtController::enable;
bool(gunProtController::*enable_2 )(const std::vector<std::string>&) = &gunProtController::enable;
bool(gunProtController::*enable_3 )()                                = &gunProtController::enable;
bool(gunProtController::*disable_1)(const std::string&)              = &gunProtController::disable;
bool(gunProtController::*disable_2)(const std::vector<std::string>&) = &gunProtController::disable;
...
BOOST_PYTHON_MODULE(VELA_CLARA_RF_Protection_Control)
{
    ...
    enum_<rfProtStructs::RF_GUN_PROT_TYPE>("RF_GUN_PROT_TYPE","RF_GUN_PROT_TYPE: a named integer giving the type of RF protection")
        .value("CLARA_HRRG",  rfProtStructs::RF_GUN_PROT_TYPE::CLARA_HRRG  )
        .value("VELA_LRRG",  rfProtStructs::RF_GUN_PROT_TYPE::VELA_LRRG  )
        .value("VELA_HRRG", rfProtStructs::RF_GUN_PROT_TYPE::VELA_HRRG )
        .value("VELA_HRRG", rfProtStructs::RF_GUN_PROT_TYPE::VELA_HRRG )
        .value("CLARA_LRRG", rfProtStructs::RF_GUN_PROT_TYPE::CLARA_LRRG )
        .value("TEST", rfProtStructs::RF_GUN_PROT_TYPE::TEST )
        .value("NOT_KNOWN", rfProtStructs::RF_GUN_PROT_TYPE::NOT_KNOWN )
        .value("GENERAL", rfProtStructs::RF_GUN_PROT_TYPE::GENERAL )
        .value("ENABLE", rfProtStructs::RF_GUN_PROT_TYPE::ENABLE )
        .value("NO_MODE", rfProtStructs::RF_GUN_PROT_TYPE::NO_MODE )
        ;

    enum_<rfProtStructs::RF_GUN_PROT_STATUS>("RF_GUN_PROT_STATUS","RF_GUN_PROT_STATUS: a named integer giving the state of an RF protection object")
        .value("GOOD",  rfProtStructs::RF_GUN_PROT_STATUS::GOOD  )
        .value("BAD",  rfProtStructs::RF_GUN_PROT_STATUS::BAD  )
        .value("ERROR", rfProtStructs::RF_GUN_PROT_STATUS::ERROR )
        .value("UNKNOWN", rfProtStructs::RF_GUN_PROT_STATUS::UNKNOWN )
        ;
    // Expose base classes
    ...
    boost::python::class_<rfProtStructs::rfGunProtObject,boost::noncopyable>
        ("rfGunProtObject","rfGunProtObject member variables (read access only)", boost::python::no_init)
        .def_readonly("name",               &rfProtStructs::rfGunProtObject::name,"object name")
        .def_readonly("pvRoot",             &rfProtStructs::rfGunProtObject::pvRoot,"object pvRoot")
        .def_readonly("status",             &rfProtStructs::rfGunProtObject::status,"object status")
        .def_readonly("cmi",                &rfProtStructs::rfGunProtObject::cmi,"object cmi")
        .def_readonly("gunProtKeyBits",     &rfProtStructs::rfGunProtObject::gunProtKeyBits,"which bits in cmi refer to physcial keys")
        .def_readonly("gunProtKeyBitValues",&rfProtStructs::rfGunProtObject::gunProtKeyBitValues,"key bit values")
        .def_readonly("protType",           &rfProtStructs::rfGunProtObject::protType,"rf gun protection type ")
        ;
 ...
 boost::python::class_<gunProtController, boost::python::bases<controller>, boost::noncopyable>
        ...
        .def("reset",       reset_1,   (boost::python::arg("name"),"reset protection by name"))
...
//        .def("reset",       &gunProtController::reset,    "resets." )
//        .def("enable",      &gunProtController::enable,    "enable." )
//        .def("disable",     &gunProtController::disable,    "disable." )
//        ;
//
//
//
