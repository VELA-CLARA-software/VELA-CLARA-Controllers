...
//        .value("SCREEN_UNKNOWN",  screenStructs::SCREEN_STATE::SCREEN_UNKNOWN)
        ...
        .value("H_MAX",           screenStructs::SCREEN_STATE::H_MAX)
...
//		;
    ...
    char const* getVELAPneumaticScreensString = "Returns a list of the VELA pneumatic screens";
    char const* getCLARAHVMoverScreensString = "Returns a list of the CLARA H/V mover screens";
    char const* getCLARAVMoverScreensString = "Returns a list of the CLARA V mover screens";
...
//        .def("isScreenInVec",         &screenController::isScreenIn_Py, (boost::python::arg("name")), isScreenInString                                    )
        ...
        .def("getVELAHVMoverScreens",   &screenController::getVELAHVMoverScreens_Py, (boost::python::arg("names")) ,getVELAHVMoverScreensString             )
        .def("getMoverScreens",         &screenController::getMoverScreens_Py, (boost::python::arg("names")) ,getMoverScreensString                         )
        .def("getHVMoverScreens",       &screenController::getHVMoverScreens_Py, (boost::python::arg("names")) ,getHVMoverScreensString                     )
        .def("getAvailableDevices",     &screenController::getAvailableDevices_Py, (boost::python::arg("name")), getAvailableDevicesString                  )
