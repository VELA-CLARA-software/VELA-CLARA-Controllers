...
//        .def_readwrite( "second", &std::pair< int, int >::second,"documentation" );
    ...
    boost::python::class_<screenStructs::screenObject,boost::noncopyable>
        ...
        .def_readonly("screenPState",     &screenStructs::screenObject::screenPState    )
...
//		;
    ...
    class_<screenController, boost::python::bases<controller>, boost::noncopyable>
        ...
        .def("isHMoving",             &screenController::isHMoving, (boost::python::arg("name")), isHMovingString                          )
        .def("isVMoving",             &screenController::isVMoving, (boost::python::arg("name")), isVMovingString                          )
        .def("isScreenMoving",        &screenController::isScreenMoving, (boost::python::arg("name")), isScreenMovingString                )
        .def("moveScreenTo",          &screenController::moveScreenTo, (boost::python::arg("name"),boost::python::arg("state")), moveScreenToString       )
