...
screenController& VCscreens::virtual_VELA_INJ_Screen_Controller()
{
    ...
    else
    {
        ...
        virtual_VELA_INJ_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, true );
    }
...
screenController& VCscreens::offline_VELA_INJ_Screen_Controller()
{
    ...
    else
    {
        ...
        offline_VELA_INJ_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, true );
    }
...
screenController& VCscreens::physical_VELA_INJ_Screen_Controller()
{
    ...
    else
    {
        ...
        physical_VELA_INJ_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, false );
    }
...
screenController& VCscreens::virtual_VELA_BA1_Screen_Controller()
{
    ...
    else
    {
        ...
        virtual_VELA_BA1_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, true );
    }
...
screenController& VCscreens::offline_VELA_BA1_Screen_Controller()
{
    ...
    else
    {
        ...
        offline_VELA_BA1_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, true );
    }
    return *offline_VELA_BA1_Screen_Controller_Obj;
}
//______________________________________________________________________________
screenController& VCscreens::physical_VELA_BA1_Screen_Controlle()
{
    std::string simpleConf  = UTL::CONFIG_PATH_VM + UTL::VELA_INJ_SIMPLE_SCREENS_CONFIG;
    std::string complexConf = UTL::CONFIG_PATH_VM + UTL::VELA_INJ_COMPLEX_SCREENS_CONFIG;
    if( physical_VELA_BA1_Screen_Controlle_Obj )
    {
    ...
    else
    {
        ...
        physical_VELA_BA1_Screen_Controlle_Obj = new screenController( true, true,complexConf, simpleConf, true );
    }
    return *physical_VELA_BA1_Screen_Controlle_Obj;
}
//______________________________________________________________________________
screenController& VCscreens::virtual_VELA_BA2_Screen_Controller()
{
    ...
    else
    {
        ...
        virtual_VELA_BA2_Screen_Controller_Obj = new screenController(   true, true,complexConf, simpleConf, false );
    }
...
screenController& VCscreens::offline_VELA_BA2_Screen_Controller()
{
    ...
    else
    {
        ...
        offline_VELA_BA2_Screen_Controller_Obj = new screenController( shouldShowMessage, shouldShowDebugMessage,complexConf, simpleConf, true );
    }
...
screenController& VCscreens::physical_VELA_BA2_Screen_Controller()
{
    ...
    else
    {
        ...
        physical_VELA_BA2_Screen_Controller_Obj = new screenController( shouldShowMessage, shouldShowDebugMessage,complexConf, simpleConf, false );
    }
...
screenController& VCscreens::virtual_CLARA_INJ_Screen_Controller()
{
    ...
    else
    {
        ...
        virtual_CLARA_INJ_Screen_Controller_Obj = new screenController( shouldShowMessage, shouldShowDebugMessage,complexConf, simpleConf, true );
    }
...
{
    std::string simpleConf  = UTL::CONFIG_PATH_VM + UTL::CLARA_INJ_SIMPLE_SCREENS_CONFIG;
    std::string complexConf = UTL::CONFIG_PATH_VM + UTL::CLARA_INJ_COMPLEX_SCREENS_CONFIG;
    if( offline_CLARA_INJ_Screen_Controller_Obj )
    {
    ...
    else
    {
        ...
        offline_CLARA_INJ_Screen_Controller_Obj = new screenController( shouldShowMessage, shouldShowDebugMessage,complexConf, simpleConf, true );
    }
...
screenController& VCscreens::physical_CLARA_INJ_Screen_Controller()
{
    ...
    else
    {
        ...
        physical_CLARA_INJ_Screen_Controller_Obj = new screenController( shouldShowMessage, shouldShowDebugMessage,complexConf, simpleConf, false );
    }
