...
class VCgun_RF
{
    public:
        ...
        /// This really needs thinking about after talking to RF guys about how it will work


//        RFGunController& virtual_VELA_RF_Gun_Controller();
//        RFGunController& physical_VELA_Screen_Controller();
//        RFGunController& offline_VELA_Screen_Controller();
