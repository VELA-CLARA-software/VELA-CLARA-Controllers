...
class VCmagnets
{
    public:
        ...
        magnetController& virtual_VELA_INJ_Magnet_Controller_NOEPICS();
    ...
    private:
        ...
        magnetController * virtual_VELA_INJ_Magnet_Controller_NOEPICS_Obj;

        bool virtual_VELA_INJ_Magnet_Controller_Obj_Exists;
        bool virtual_VELA_INJ_Magnet_Controller_NOEPICS_Obj_Exists;
...
//const msst&(magnetController::*getMagObjConstRef)(cstr &) = &magnetController::getMagObjConstRef;


using namespace boost::python;

BOOST_PYTHON_MODULE( VC_MagnetControl )
{
...
//
    ...
    boost::python::class_<magnetController, boost::python::bases<controller>, boost::noncopyable>
        ...
        .def("getCurrentMagnetState",    getCurrentMagnetState_1)//,return_value_policy<reference_existing_object>())
        .def("getCurrentMagnetState",    getCurrentMagnetState_2)//,return_value_policy<reference_existing_object>())
    ...
    boost::python::class_<VCmagnets,boost::noncopyable> ("VCmagnets")
        .def("virtual_VELA_INJ_Magnet_Controller",  &VCmagnets::virtual_VELA_INJ_Magnet_Controller,
             return_value_policy<reference_existing_object>())
        .def("virtual_VELA_INJ_Magnet_Controller_NOEPICS",  &VCmagnets::virtual_VELA_INJ_Magnet_Controller_NOEPICS,        return_value_policy<reference_existing_object>())
    ;
