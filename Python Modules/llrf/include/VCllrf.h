...
//        .def_readonly("current_trace",&rf_trace_data::current_trace,"index for current trace.")
    ...
    class_<liberallrfObject,boost::noncopyable>
        ...
        .def_readonly("max_amp",   &liberallrfObject::maxAmp,"Maximum Allowed Amplitude Set Point (for this module).")
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        .def("areLLRFTraceInterlocksGood",&liberaLLRFController::areLLRFTraceInterlocksGood, "Returns TRUE if all LLRF trace interlocks are good")
        .def("areLLRFTraceInterlocksBad", &liberaLLRFController::areLLRFTraceInterlocksBad , "Returns TRUE if any LLRF trace interlock  is  bad ")
        .def("getCh1Interlock",       &liberaLLRFController::getCh1Interlock,       "Get Ch1 LLRF Interlock State"         )
        .def("getCh1InterlockEnable", &liberaLLRFController::getCh1InterlockEnable, "Get Ch1 LLRF Interlock Enabled State" )
        .def("getCh1InterlockU",      &liberaLLRFController::getCh1InterlockU,      "Get Ch1 LLRF Interlock U level"       )
        .def("getCh1InterlockP",      &liberaLLRFController::getCh1InterlockP,      "Get Ch1 LLRF Interlock P level"       )
        .def("getCh1InterlockPdbm",   &liberaLLRFController::getCh1InterlockPdbm,   "Get Ch1 LLRF Interlock Pdbm level "   )
        .def("getCh2Interlock",       &liberaLLRFController::getCh2Interlock,       "Get Ch2 LLRF Interlock State"         )
        .def("getCh2InterlockEnable", &liberaLLRFController::getCh2InterlockEnable, "Get Ch2 LLRF Interlock Enabled State" )
        .def("getCh2InterlockU",      &liberaLLRFController::getCh2InterlockU,      "Get Ch2 LLRF Interlock U level"       )
        .def("getCh2InterlockP",      &liberaLLRFController::getCh2InterlockP,      "Get Ch2 LLRF Interlock P level"       )
        .def("getCh2InterlockPdbm",   &liberaLLRFController::getCh2InterlockPdbm,   "Get Ch2 LLRF Interlock Pdbm level "   )
        .def("getCh3Interlock",       &liberaLLRFController::getCh3Interlock,       "Get Ch3 LLRF Interlock State"         )
        .def("getCh3InterlockEnable", &liberaLLRFController::getCh3InterlockEnable, "Get Ch3 LLRF Interlock Enabled State" )
        .def("getCh3InterlockU",      &liberaLLRFController::getCh3InterlockU,      "Get Ch3 LLRF Interlock U level"       )
        .def("getCh3InterlockP",      &liberaLLRFController::getCh3InterlockP,      "Get Ch3 LLRF Interlock P level"       )
        .def("getCh3InterlockPdbm",   &liberaLLRFController::getCh3InterlockPdbm,   "Get Ch3 LLRF Interlock Pdbm level "   )
        .def("getCh4Interlock",       &liberaLLRFController::getCh4Interlock,       "Get Ch4 LLRF Interlock State"         )
        .def("getCh4InterlockEnable", &liberaLLRFController::getCh4InterlockEnable, "Get Ch4 LLRF Interlock Enabled State" )
        .def("getCh4InterlockU",      &liberaLLRFController::getCh4InterlockU,      "Get Ch4 LLRF Interlock U level"       )
        .def("getCh4InterlockP",      &liberaLLRFController::getCh4InterlockP,      "Get Ch4 LLRF Interlock P level"       )
        .def("getCh4InterlockPdbm",   &liberaLLRFController::getCh4InterlockPdbm,   "Get Ch4 LLRF Interlock Pdbm level "   )
        .def("getCh5Interlock",       &liberaLLRFController::getCh5Interlock,       "Get Ch5 LLRF Interlock State"         )
        .def("getCh5InterlockEnable", &liberaLLRFController::getCh5InterlockEnable, "Get Ch5 LLRF Interlock Enabled State" )
        .def("getCh5InterlockU",      &liberaLLRFController::getCh5InterlockU,      "Get Ch5 LLRF Interlock U level"       )
        .def("getCh5InterlockP",      &liberaLLRFController::getCh5InterlockP,      "Get Ch5 LLRF Interlock P level"       )
        .def("getCh5InterlockPdbm",   &liberaLLRFController::getCh5InterlockPdbm,   "Get Ch5 LLRF Interlock Pdbm level "   )
        .def("getCh6Interlock",       &liberaLLRFController::getCh6Interlock,       "Get Ch6 LLRF Interlock State"         )
        .def("getCh6InterlockEnable", &liberaLLRFController::getCh6InterlockEnable, "Get Ch6 LLRF Interlock Enabled State" )
        .def("getCh6InterlockU",      &liberaLLRFController::getCh6InterlockU,      "Get Ch6 LLRF Interlock U level"       )
        .def("getCh6InterlockP",      &liberaLLRFController::getCh6InterlockP,      "Get Ch6 LLRF Interlock P level"       )
        .def("getCh6InterlockPdbm",   &liberaLLRFController::getCh6InterlockPdbm,   "Get Ch6 LLRF Interlock Pdbm level "   )
        .def("getCh7Interlock",       &liberaLLRFController::getCh7Interlock,       "Get Ch7 LLRF Interlock State"         )
        .def("getCh7InterlockEnable", &liberaLLRFController::getCh7InterlockEnable, "Get Ch7 LLRF Interlock Enabled State" )
        .def("getCh7InterlockU",      &liberaLLRFController::getCh7InterlockU,      "Get Ch7 LLRF Interlock U level"       )
        .def("getCh7InterlockP",      &liberaLLRFController::getCh7InterlockP,      "Get Ch7 LLRF Interlock P level"       )
        .def("getCh7InterlockPdbm",   &liberaLLRFController::getCh7InterlockPdbm,   "Get Ch7 LLRF Interlock Pdbm level "   )
        .def("getCh8Interlock",       &liberaLLRFController::getCh8Interlock,       "Get Ch8 LLRF Interlock State"         )
        .def("getCh8InterlockEnable", &liberaLLRFController::getCh8InterlockEnable, "Get Ch8 LLRF Interlock Enabled State" )
        .def("getCh8InterlockU",      &liberaLLRFController::getCh8InterlockU,      "Get Ch8 LLRF Interlock U level"       )
        .def("getCh8InterlockP",      &liberaLLRFController::getCh8InterlockP,      "Get Ch8 LLRF Interlock P level"       )
        .def("getCh8InterlockPdbm",   &liberaLLRFController::getCh8InterlockPdbm,   "Get Ch8 LLRF Interlock Pdbm level "   )
