...
class VCllrf
{
    ...
    public:
        VCllrf();
        ~VCllrf();
        llrfController& virtual_Laser_Controller();
        llrfController& physical_Laser_Controller();
        llrfController& offline_Laser_Controller();
    ...
    private:
     ...
     /// we just need to decide good names for these things...
        llrfController * virtual_Laser_Controller_Obj ;
        llrfController * physical_Laser_Controller_Obj;
        llrfController * offline_Laser_Controller_Obj ;
...
//        ;
    ...
    /// The main class that creates all the controller obejcts
        ...
        .def("virtual_Laser_Controller",  &VCllrf::virtual_Laser_Controller,
             return_value_policy<reference_existing_object>())
        .def("physical_Laser_Controller",  &VCllrf::physical_Laser_Controller,
             return_value_policy<reference_existing_object>())
        .def("offline_Laser_Controller",  &VCllrf::offline_Laser_Controller,
             return_value_policy<reference_existing_object>())
