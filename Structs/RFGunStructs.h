#ifndef _VELA_RF_STRUCTS_H_
#define _VELA_RF_STRUCTS_H_
//
#include "structs.h"
//stl
#include <vector>
...
class RFGunInterface;

namespace RFGunStructs
{
    struct pvStruct;
    ...
    DEFINE_ENUM_WITH_STRING_CONVERSIONS( RF_PV_TYPE, (RF_PWR_REV) (RF_PWR_FWD) (RF_PWR_REVT) (RF_PWR_FWDT) (RF_PWR_REVTM) (RF_PWR_FWDTM) (RF_PWR_RATIO)
                                                     (RF_AMP_READ) (RF_AMP_WRITE) (RF_PHI) (MOD_STATE_SET) (MOD_STATE_READ) (MOD_ERROR_READ) (MOD_ERROR_READ_STR) (MOD_WARMUP_TIME) (MOD_RESET) )
    ...
    DEFINE_ENUM_WITH_STRING_CONVERSIONS( MOD_STATE, (ERROR1) (UNKNOWN1) (OFF) (off_Request)            //    (OFF)             = 2,
    ...
    {                                                                                                  //    (HV_On)           = 10,
        ...
        RF_PV_TYPE     pvType;                                                                         //    (Trig_Off_Req)    = 11,
    ...
    struct rfModObject
    {
        rfModObject() : state( MOD_STATE::ERROR1 ), ilck(UNKNOWN), safelyWarmedUP( false ) {}
        std::string name, pvRoot;
        MOD_STATE    state;
        long         warmuptime;
    ...
    #ifndef __CINT__
        std::map< RF_PV_TYPE, pvStruct > pvMonStructs, pvComStructs;
    #endif
    };
