...
namespace VELA_ENUM/// this seems like a really out of date name now...
{
   ...
   /// SHould these go here? should the names be rationalised?
    ...
    DEFINE_ENUM_WITH_STRING_CONVERSIONS(MACHINE_MODE, (OFFLINE) (VIRTUAL) (PHYSICAL) (UNKNOWN_MACHINE_MODE))
    DEFINE_ENUM_WITH_STRING_CONVERSIONS(MACHINE_AREA, (VELA_INJ) (VELA_BA1) (VELA_BA2) (CLARA_PH1)
                                                       (CLARA_INJ) (CLARA_2_VELA) (CLARA_S01) (CLARA_S02) (CLARA_L01) (UNKNOWN_AREA) (USER))
    DEFINE_ENUM_WITH_STRING_CONVERSIONS(CONTROLLER_TYPE, (MAGNET) (LLRF) (BPM)(CAMERA_IA)(CAMERA_DAQ)(SCREEN)(SCOPE)
                                        (GENERAL_MONITOR)(PI_LASER)(VAC_VALVES)(SHUTTER)(IMG)
                                        (RF_MOD)(RF_PROT)(UNKNOWN_CONTROLLER_TYPE))
