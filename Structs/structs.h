...
namespace VC_ENUM
{
   ...
   /// SHould these go here? should the names be rationalised?
    ...
    /// hmm maybe MAG_PSU_STATE should not be here... and be in magnetStructs ?
    ...
    struct iLockMonitorStruct
    {
        ...
        std::string objName;
        VC_ENUM::ILOCK_NUMBER iLockNumber;  /// Used in debugMessage;
        VC_ENUM::ILOCK_STATE  * iLockState; /// this value comes from the map in the derived hardware class
...
/// legacy, eventually everything should move out of this namespace to the above one
namespace VELA_ENUM
{
   /// >>>> ???
   /// SHould these go here? should the names be rationalised?
