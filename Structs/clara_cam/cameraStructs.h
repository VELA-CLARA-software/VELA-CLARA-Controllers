...
namespace cameraStructs
{
    ...
    struct cameraDAQObject
    {
        cameraDAQObject() : name(UTL::UNKNOWN_NAME),
                            ...
                            array_data_num_pix_x(UTL::ZERO_SIZET),
                            array_data_num_pix_y(UTL::ZERO_SIZET),
                            arrayDataBufferSize(UTL::ZERO_SIZET),
                            arrayDataBufferFull(false),
                            interface(nullptr),
                            monitorArrayData(false)
                            {}
        //ID
        ...
        bool monitorArrayData;
        size_t array_data_num_pix_x,array_data_num_pix_y,arrayDataBufferSize;
        bool arrayDataBufferFull;
        double array_data_x_pix_to_mm,array_data_y_pix_to_mm;
        std::vector<long> arrayData;
        std::deque<std::vector<long>> arrayDataBuffer;
    };
    struct cameraOfflineIAObject
    {
