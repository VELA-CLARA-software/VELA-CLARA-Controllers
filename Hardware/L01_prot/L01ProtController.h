...
//  FileName:    L01ProtController.h
//  Description:
//
//
//*/
#ifndef L01_CONTROLLER_H_
#define L01_CONTROLLER_H_
// stl
#include <string>
#include <vector>
#include <map>
...
class L01ProtController : public controller
{
    ...
    private:
        ...
        const bool shouldStartEPICs;
        L01ProtInterface localInterface;
};
