...
#ifndef velaINJscreenInterface_H
#define velaINJscreenInterface_H
//djs
...
class velaINJscreenInterface: public interface
{
    public:
        ...
        velaINJscreenInterface(const std::string & conf1,
                        const bool startVirtualMachine,
                        const bool* show_messages_ptr,
                        const bool* show_debug_messages_ptr,
                        const bool shouldStartEPICs,
                        const VELA_ENUM::MACHINE_AREA myMachineArea );
        ~velaINJscreenInterface();
    ...
    private:
        ...
        typedef  bool(velaINJscreenInterface::*isOCMemFn)(const std::string & );
        typedef  void(velaINJscreenInterface::*OCMemFn)  (const std::string & );
