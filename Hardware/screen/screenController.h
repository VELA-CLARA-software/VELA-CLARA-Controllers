...
class screenController : public controller
{
    public:
        ...
        bool screenIN (const std::vector<std::string> & name);
        bool screenOUT(const std::string& name );
        bool screenOUT(const std::vector<std::string> & name);
        ...
        std::vector<bool>  isScreenIN (const std::vector<std::string> & names);
