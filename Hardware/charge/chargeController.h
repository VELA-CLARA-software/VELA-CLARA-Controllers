...
//        void monitorForNShots_Vec( const std::vector< std::string > charges, size_t N );
        ...
        #ifdef BUILD_DLL
        boost::python::list getChargeVector_Py( const std::string & name );
        boost::python::list getVoltageVector_Py( const std::string & name );
        boost::python::list getWCMChargeVector_Py();
        boost::python::list getWCMVoltageVector_Py();
        boost::python::list getS02FCUPChargeVector_Py();
        boost::python::list getS02FCUPVoltageVector_Py();
