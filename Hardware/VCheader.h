...
//                                &magnetStructs::magnetObject::setPSU)
            ...
            .def_readonly("x",              &analysis_data::x)
            .def_readonly("y",              &analysis_data::y)
            .def_readonly("sig_x",          &analysis_data::sig_x)
            .def_readonly("sig_y",          &analysis_data::sig_y)
            .def_readonly("sig_xy",         &analysis_data::sig_xy)
            .def_readonly("x_pix",          &analysis_data::x_pix)
            .def_readonly("sig_x_pix",      &analysis_data::sig_x_pix)
            .def_readonly("sig_y_pix",      &analysis_data::sig_y_pix)
            .def_readonly("sig_xy_pix",     &analysis_data::sig_xy_pix)
