...
velaCamInterface::velaCamInterface(const std::string &allGunProtsConf,
...
{
    if(shouldStartEPICs )
        message("velaCamInterface shouldStartEPICs is true");
    else
        message("velaCamInterface shouldStartEPICs is false");
    initialise();
}
...
//______________________________________________________________________________
void velaCamInterface::killMonitor(rfProtStructs::monitorStruct * ms )
{
...
//______________________________________________________________________________
void velaCamInterface::initialise()
{
    ...
    if(configFileRead )
    {
        message("The velaCamInterface has read the config file, acquiring objects");
        ...
        if(getDataSuccess)
        {
            ...
            if(shouldStartEPICs)
            {
                message("The velaCamInterface has acquired objects, connecting to EPICS");
             ...
             message("The velaCamInterface has acquired objects, NOT connecting to EPICS");
        }
        else
            message("!!!The velaCamInterface received an Error while getting laser data!!!");
    }
}
//______________________________________________________________________________
void velaCamInterface::initChids()
{
...
////______________________________________________________________________________
void velaCamInterface::addChannel(const std::string & pvRoot, rfProtStructs::pvStruct & pv )
{
